  ...
  >
    <g class="gantt-elastic__grid-lines" :style="{ ...root.style['grid-lines'] }">
      <line
        ...
        :key="line.key"
        :x1="transformNumber(line.x1)"
        :y1="transformNumber(line.y1)"
        :x2="transformNumber(line.x2)"
        :y2="transformNumber(line.y2)"
      ></line>
      <line
      ...
      <line
        ...
        :x1="transformNumber(timeLinePosition.x)"
        :y1="transformNumber(timeLinePosition.y1)"
        :x2="transformNumber(timeLinePosition.x)"
        :y2="transformNumber(timeLinePosition.y2)"
      ></line>
    </g>
  </svg>
</template>
